...
nice -n 1000 python3 /scratch/cb761230/perf-oriented-dev/solutions/exercise2/benchmark.py /scratch/cb761230/perf-oriented-dev/solutions/exercise2/taskA/lcc3/config.yaml
killall loadgen &> /dev/null
